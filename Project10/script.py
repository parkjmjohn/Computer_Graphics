...
def run(filename):
    ...
    # ==========================
    light_shading = get_light_shading(symbols)
    # ==========================
    print "NOTE: ONLY FLAT SHADING SUPPORTED AND ONLY ONE LIGHT/CONSTANT SUPPORTED."
    ...
    for f in range(num_frames):
        ...
        for command in commands:
            ...
            if c == 'set':
                ...
                draw_polygons(tmp, screen, zb, color, light_shading)     # ==========================
                tmp = []
            elif c == 'sphere':
                add_sphere(tmp,
